...
echo ""
echo "  1. Go to Apps → Discover Apps → Manage Catalogs → Add Catalog:"
echo "     Name:   Android Agent"
echo "     Repo:   https://github.com/${GITHUB_USER}/${REPO_NAME}"
echo "     Train:  community"
echo "     Branch: main"
echo ""
echo "  2. After the image build finishes (~20 min), search 'Android Agent'"
echo "     in the Apps catalog and click Install."
echo "     (Storage is auto-provisioned — no pre-install needed.)"
echo ""
